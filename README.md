...
## 🔎 Problem Solving:
- If the Roblox window fails to focus in time or key presses do not register correctly, increase the delay in the `settings.json` file. (This file is automatically generated upon the first launch.) Restart the program for changes to take effect.
